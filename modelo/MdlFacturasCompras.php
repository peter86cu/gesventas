...
static public function buscarOrdenCompra($idOrden){  
	...
	static public function updateCompras($idCompra,$idOrden,$plazo, $fecha ,$formaPago, $estado,$factura,$receptor,$moneda,$deposito){
		...
		$stmt= $obj->actualizar("entradas_compras", 
			...
			"estado='".$estado."',fecha_hora='".$fecha."',id_sucursal='".$_SESSION["sucursal"]."',id_usuario='".$_SESSION["id"]."',id_deposito='".$deposito."',id_usuario_recibio='".$receptor."',id_forma_pago='".$formaPago."',id_plazo='".$plazo."',id_orden_compra='".$idOrden."', nro_factura='".$factura."',id_moneda='".$moneda."'", 
			"id_entrada_compra ='".$idCompra."'");
