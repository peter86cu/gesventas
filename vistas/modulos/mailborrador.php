<!-- Content Wrapper. Contains page content -->
  ...
  foreach ($cantidad as $key => $value) {
    $sin_leer=$value['sin_leer'];
                     ...
                     $cantborra= "SELECT count(*) sin_leer FROM `mail_sent` WHERE id_usuario='".encriptaDatos::encriptar($_SESSION['id'])."' and estado=0 and accion=6";
                    $cantidad_borrador = ControlMail::buscarMail($parametro,$cantborra);
                    $sin_leer_borrador=0;
                    foreach ($cantidad_borrador as $key => $value) {
                      $sin_leer_borrador=$value['sin_leer'];
            ...
            <div class="card-body p-0">
              <ul class="nav nav-pills flex-column">
                ...
                <li class="nav-item">
                  <a href="mailsend" class="nav-link">
                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                    <a href="mailborrador" class="nav-link">
                      <i class="far fa-file-alt"></i> Borradores
                      <span class="badge bg-primary float-right"><?php echo $sin_leer_borrador ?></span>
                    </a>
                  </li>
              </ul>
            </div>
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body p-0">
              <div class="mailbox-controls">
                ...
                <div class="btn-group">
                  <button type="button" class="btn btn-default btn-sm" onclick="moverDelete('salida')" >
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  <tbody>
                    ...
                    $parametro= null;
                    $datos= "SELECT * FROM `mail_sent` WHERE id_usuario='".encriptaDatos::encriptar($_SESSION['id'])."' and accion=6 order by id desc";   
                    $email_destinos ="";
                    $asunto ="";
                    $mail = ControlMail::buscarMail($parametro,$datos);
                     foreach ($mail as $key => $value) {                     
                      $strTimeAgo = timeago(encriptaDatos::desencriptar($value["datemail"]));
                      if($value['email_destinos']!=null){
                       $email_destinos =  encriptaDatos::desencriptar($value['email_destinos']);            
                      }else{
                        $email_destinos ='Sin destinos';
                      }
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name" style="color: #000000"><a href="javascript:void(0);" style="color: #000000" onClick="marcarLeido(<?php echo $value['id'] ?>,'borrador');" > <?php  echo $email_destinos ?></a> </td>  

                   
                    <td class="mailbox-subject"><a href="javascript:void(0);" style="color: #000000" onClick="marcarLeido(<?php echo $value['id'] ?>,'salida');" <?php echo $value['id'] ?> >   <?php echo $asunto ?> 
                    </td>
