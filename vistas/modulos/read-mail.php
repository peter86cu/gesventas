  ...
  if($_SESSION['accion_mail']=='entrada'){
   $identificador = $_SESSION['id_mail'];
            ...
            if (isset($_SESSION['adjunto_mail'])){
              if($_SESSION['adjunto_mail']=='enviar_adjunto'){
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      <div class="card card-primary card-outline">
                        <div class="card-header">
                          <h3 class="card-title"><p><h5><strong>De: </strong><?php if($_SESSION['accion_mail']!='salida') { echo $nombre; }else{ echo $_SESSION['nombres']; } ?><p id="idMail"><?php echo $from; ?></p> </h5>
                            ...
                            <div class="card-body p-0">
                              <div class="mailbox-read-info">               
                                ...
                                <!-- /.mailbox-controls -->
                                <div class="mailbox-read-message" id="idBody">
                                  <?php echo $body ?>
                                </div>
                              ...
                              <div class="card-footer">
                                <div class="float-right">
                                  <button type="button" class="btn btn-default" onclick="leerMail(<?php echo $_SESSION['id_mail'] ?>,<?php echo $sin_leer ?>,'responder')" ><i class="fas fa-reply"></i> Responder</button>
                                  <button type="button" class="btn btn-default"><i class="fas fa-share"></i> Reenviar</button>
                                </div>
                                <button type="button" class="btn btn-default" onclick="moverDeleteLectura(<?php echo $_SESSION['id_mail'] ?>,'<?php echo $_SESSION['accion_mail']?>')"><i class="far fa-trash-alt" ></i> Eliminar</button>
