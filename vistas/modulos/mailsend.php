          ...
          <div class="card-body p-0">
            ...
            <div class="table-responsive mailbox-messages">
              <table class="table table-hover table-striped">
                ...
                $parametro= null;
                $datos= "SELECT * FROM `mail_sent` WHERE id_usuario='".encriptaDatos::encriptar($_SESSION['id'])."' and accion=7 order by id desc";                    
                ...
                foreach ($mail as $key => $value) {                     
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name" style="color: #000000"><a href="javascript:void(0);" style="color: #000000" onClick="marcarLeido(<?php echo $value['id'] ?>,'salida');" > <?php echo encriptaDatos::desencriptar($value['email_destinos']) ?></a> </td>  
